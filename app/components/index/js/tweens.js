...
const playOneSec = {duration: 1000}, reversable = {reversable: true};
...
const tweens = {
    ...
    portfolio: {
      ...
      showThumbnail: KUTE.allFromTo(".PORTFOLIO__entry",
        {translateY: '100%', scale: 2, ...fadeStart},
        {translateY: 0, scale: 1, ...fadeEnd},
        {easing: 'easingElasticInOut', offset: 200, delay: 500, ... playOneSec})
    },
    skills: {
      header: headerTween(".SKLLLS__header"),
      showProgressLeft: KUTE.allFromTo(".SKILLS__progress.left",
        {translateX: '-150%', scale: 2, ...fadeQuarter},
        {translateX: 0, scale: 1, ...fadeEnd},
        {easing: 'easingBackIn', offset: 100, ...playOneSec}),
