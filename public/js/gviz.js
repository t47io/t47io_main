...
function drawGIT(repo) {
    var chart = new google.visualization.ChartWrapper({
        'chartType': 'AreaChart',
        'dataSourceUrl': '/git/?type=c&repo=' + repo,
    ...
    var chart = new google.visualization.ChartWrapper({
        'chartType': 'AreaChart',
        'dataSourceUrl': '/git/?type=a&repo=' + repo,
    ...
    for (var i = 0; i < repo.length; i++) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#git-url-" + name).html('<a href="http://' + data.url + '" target="_blank"><code>' + data.url + '</code> <i class="fa fa-fw fa-sm fa-external-link"></i></a>');
